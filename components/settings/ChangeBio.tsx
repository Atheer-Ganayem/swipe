...
import { changeBio } from "@/libs/actions/settings";
...
const ChangeBio = () => {
  ...
  const [state, action] = useFormState(changeBio, { error: false, message: "" });
  ...
  return (
    <form action={action} ref={formRef} className="card w-96 bg-base-200 shadow-xl p-5 mx-auto">
      ...
      <div className="flex flex-col gap-6">
        ...
        <textarea
          name="bio"
          placeholder="New Bio (250 Character max)"
